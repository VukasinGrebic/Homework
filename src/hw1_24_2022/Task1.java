...
public class Task1 {
	...
	public static void main(String[] args) {
		...
		Tetrapak tetrapak = new Tetrapak("2323", "Tetrapak", 100, 120, true, 1000);
		StaklenaAmbalaza sa = new StaklenaAmbalaza("2223", "Staklo", 90, 150, 50, true, 800);
		SuperKartica superkartica = new SuperKartica("11", "Marko Markovic", 300);

		Korpa korpa = new Korpa();

		korpa.dodajAmabalazu(tetrapak);
		korpa.izbaciAmbalazu("2223");
		korpa.dodajAmabalazu(sa);
		superkartica.print();
		korpa.ukupnaCena(superkartica);
		korpa.printAll(superkartica);
