...
public class Task2 {
	...
	public static void main(String[] args) {
		Account a = new Account("983498394983", "Marko Markovic", 100);
		a.changeBalance(9900);
		
		Account b = new Account("232323232323", "Milos Milkovic", 100);
		b.changeBalance(-100);
		
		
		Transaction a1 = new Transaction("323", a, b);
		a1.transaction(5000);
		a.print();
		b.print();
	}
