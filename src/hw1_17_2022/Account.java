...
public class Account {
	...
	public Account (String accNumber, String fLName, double cBalance) {
		this.accNumber = accNumber;
		this.fLName = fLName;
		this.cBalance = 100;
	}
	...
	public void print () {
		System.out.println(this.fLName + " - " + this.accNumber);
		System.out.println("Your current balance is " + this.cBalance + " RSD");
		System.out.println();
	}
